...
DEFAULT_RSS_FEEDS = {
    "전체": [
        ...
        {"name": "매일경제", "url": "https://www.mk.co.kr/rss/30000001/", "logo": "💹", "enabled": True},
        {"name": "SBS 뉴스", "url": "https://news.sbs.co.kr/news/headlineRssFeed.do?plink=RSSREADER", "logo": "🟡", "enabled": True},
        {"name": "조선일보", "url": "https://www.chosun.com/arc/outboundfeeds/rss/?outputType=xml", "logo": "⚫", "enabled": True},
    ...
    "정치": [
        {"name": "한국경제 정치", "url": "https://www.hankyung.com/feed/politics", "logo": "📈", "enabled": True},
        {"name": "연합뉴스 정치", "url": "https://www.yna.co.kr/rss/politics.xml", "logo": "🔴", "enabled": True},
        {"name": "동아일보 정치", "url": "https://rss.donga.com/politics.xml", "logo": "⭕", "enabled": True},
        {"name": "SBS 정치", "url": "https://news.sbs.co.kr/news/SectionRssFeed.do?sectionId=01&plink=RSSREADER", "logo": "🟡", "enabled": True},
        {"name": "조선일보 정치", "url": "https://www.chosun.com/arc/outboundfeeds/rss/category/politics/?outputType=xml", "logo": "⚫", "enabled": True},
    ...
    "경제": [
        {"name": "한국경제 경제", "url": "https://www.hankyung.com/feed/economy", "logo": "📈", "enabled": True},
        {"name": "연합뉴스 경제", "url": "https://www.yna.co.kr/rss/economy.xml", "logo": "🔴", "enabled": True},
        {"name": "매일경제 기업·경영", "url": "https://www.mk.co.kr/rss/50100032/", "logo": "💹", "enabled": True},
        {"name": "동아일보 경제", "url": "https://rss.donga.com/economy.xml", "logo": "⭕", "enabled": True},
        {"name": "SBS 경제", "url": "https://news.sbs.co.kr/news/SectionRssFeed.do?sectionId=02&plink=RSSREADER", "logo": "🟡", "enabled": True},
        {"name": "조선일보 경제", "url": "https://www.chosun.com/arc/outboundfeeds/rss/category/economy/?outputType=xml", "logo": "⚫", "enabled": True},
        {"name": "경향신문 경제", "url": "https://www.khan.co.kr/rss/rssdata/economy_news.xml", "logo": "🔶", "enabled": True},
        {"name": "한겨레 경제", "url": "https://www.hani.co.kr/rss/economy/", "logo": "🔷", "enabled": True},
    ],
    "부동산": [
        {"name": "매일경제 부동산", "url": "https://www.mk.co.kr/rss/50300009/", "logo": "🏢", "enabled": True},
        {"name": "한국경제 부동산", "url": "https://www.hankyung.com/feed/realestate", "logo": "📈", "enabled": True},
        {"name": "아시아경제 부동산", "url": "https://www.asiae.co.kr/rss/realestate.htm", "logo": "🏘️", "enabled": True},
        {"name": "조선비즈 부동산", "url": "https://biz.chosun.com/arc/outboundfeeds/rss/category/real_estate/?outputType=xml", "logo": "⚫", "enabled": True},
    ],
    "증권": [
        {"name": "매일경제 증권", "url": "https://www.mk.co.kr/rss/50200011/", "logo": "💹", "enabled": True},
        {"name": "연합뉴스 증시/마켓", "url": "https://www.yna.co.kr/rss/market.xml", "logo": "🔴", "enabled": True},
        {"name": "한국경제 증권", "url": "https://www.hankyung.com/feed/finance", "logo": "📈", "enabled": True},
        {"name": "아시아경제 증권", "url": "https://www.asiae.co.kr/rss/stock.htm", "logo": "📊", "enabled": True},
        {"name": "조선비즈 증권", "url": "https://biz.chosun.com/arc/outboundfeeds/rss/category/stock/?outputType=xml", "logo": "⚫", "enabled": True},
    ],
    "연예": [
        {"name": "한국경제 연예", "url": "https://www.hankyung.com/feed/entertainment", "logo": "⭐", "enabled": True},
        {"name": "연합뉴스 연예", "url": "https://www.yna.co.kr/rss/entertainment.xml", "logo": "🔴", "enabled": True},
        {"name": "스포츠동아 연예", "url": "https://rss.donga.com/sportsdonga/entertainment.xml", "logo": "🎬", "enabled": True},
        {"name": "조선일보 연예", "url": "https://www.chosun.com/arc/outboundfeeds/rss/category/entertainments/?outputType=xml", "logo": "⚫", "enabled": True},
        {"name": "동아일보 연예", "url": "https://rss.donga.com/entertainment.xml", "logo": "🎭", "enabled": True},
    ],
    "사회": [
        {"name": "한국경제 사회", "url": "https://www.hankyung.com/feed/society", "logo": "📈", "enabled": True},
        {"name": "연합뉴스 사회", "url": "https://www.yna.co.kr/rss/society.xml", "logo": "🔴", "enabled": True},
        {"name": "매일경제 사회", "url": "https://www.mk.co.kr/rss/50400012/", "logo": "💹", "enabled": True},
        {"name": "동아일보 사회", "url": "https://rss.donga.com/national.xml", "logo": "⭕", "enabled": True},
        {"name": "SBS 사회", "url": "https://news.sbs.co.kr/news/SectionRssFeed.do?sectionId=03&plink=RSSREADER", "logo": "🟡", "enabled": True},
        {"name": "조선일보 사회", "url": "https://www.chosun.com/arc/outboundfeeds/rss/category/national/?outputType=xml", "logo": "⚫", "enabled": True},
        {"name": "한겨레 사회", "url": "https://www.hani.co.kr/rss/society/", "logo": "🔷", "enabled": True},
        {"name": "경향신문 사회", "url": "https://www.khan.co.kr/rss/rssdata/society_news.xml", "logo": "🔶", "enabled": True},
    ],
    "IT/과학": [
        {"name": "한국경제 IT", "url": "https://www.hankyung.com/feed/it", "logo": "💻", "enabled": True},
        {"name": "조선비즈 IT/과학", "url": "https://biz.chosun.com/arc/outboundfeeds/rss/category/it-science/?outputType=xml", "logo": "🔬", "enabled": True},
        {"name": "전자신문", "url": "https://rss.etnews.com/Section902.xml", "logo": "⚡", "enabled": True},
        {"name": "지디넷코리아", "url": "https://feeds.feedburner.com/zdkorea", "logo": "🤖", "enabled": True},
        {"name": "블로터", "url": "https://www.bloter.net/rss/allArticle.xml", "logo": "📱", "enabled": True},
        {"name": "한겨레 과학", "url": "https://www.hani.co.kr/rss/science/", "logo": "🔷", "enabled": True},
        {"name": "경향신문 과학", "url": "https://www.khan.co.kr/rss/rssdata/science_news.xml", "logo": "🔶", "enabled": True},
    ],
    "스포츠": [
        {"name": "한국경제 스포츠", "url": "https://www.hankyung.com/feed/sports", "logo": "🏅", "enabled": True},
        {"name": "연합뉴스 스포츠", "url": "https://www.yna.co.kr/rss/sports.xml", "logo": "⚽", "enabled": True},
        {"name": "동아일보 스포츠", "url": "https://rss.donga.com/sports.xml", "logo": "⭕", "enabled": True},
        {"name": "SBS 스포츠", "url": "https://news.sbs.co.kr/news/SectionRssFeed.do?sectionId=09&plink=RSSREADER", "logo": "⚾", "enabled": True},
        {"name": "조선일보 스포츠", "url": "https://www.chosun.com/arc/outboundfeeds/rss/category/sports/?outputType=xml", "logo": "⚫", "enabled": True},
    ],
    "세계": [
        {"name": "한국경제 국제", "url": "https://www.hankyung.com/feed/international", "logo": "🌍", "enabled": True},
        {"name": "연합뉴스 국제", "url": "https://www.yna.co.kr/rss/international.xml", "logo": "🔴", "enabled": True},
        {"name": "동아일보 국제", "url": "https://rss.donga.com/international.xml", "logo": "⭕", "enabled": True},
        {"name": "SBS 국제", "url": "https://news.sbs.co.kr/news/SectionRssFeed.do?sectionId=07&plink=RSSREADER", "logo": "🌐", "enabled": True},
        {"name": "조선일보 국제", "url": "https://www.chosun.com/arc/outboundfeeds/rss/category/international/?outputType=xml", "logo": "⚫", "enabled": True},
        {"name": "한겨레 국제", "url": "https://www.hani.co.kr/rss/international/", "logo": "🔷", "enabled": True},
        {"name": "경향신문 국제", "url": "https://www.khan.co.kr/rss/rssdata/world_news.xml", "logo": "🔶", "enabled": True},
    ],
    "문화": [
        {"name": "한국경제 라이프", "url": "https://www.hankyung.com/feed/life", "logo": "☕", "enabled": True},
        {"name": "연합뉴스 문화", "url": "https://www.yna.co.kr/rss/culture.xml", "logo": "🎭", "enabled": True},
        {"name": "동아일보 문화", "url": "https://rss.donga.com/culture.xml", "logo": "⭕", "enabled": True},
        {"name": "조선일보 문화", "url": "https://www.chosun.com/arc/outboundfeeds/rss/category/culture-life/?outputType=xml", "logo": "⚫", "enabled": True},
        {"name": "한겨레 문화", "url": "https://www.hani.co.kr/rss/culture/", "logo": "🔷", "enabled": True},
        {"name": "경향신문 문화", "url": "https://www.khan.co.kr/rss/rssdata/culture_news.xml", "logo": "🔶", "enabled": True},
    ],
}
...
def get_raw_origin_image(url, title=None):
    ...
    try:
        ...
        if resp.status_code == 200 and len(resp.content) > 150:
            ...
            # 1-2. 본문 컨테이너 내 첫 번째 유효 보도 사진 (사이드바/헤더/인기뉴스 광고 제외)
            body = (
                ...
                soup.find('div', id='article_body') or          # 중앙/매경
                soup.find('article')
            )
            if body:
                for im in body.find_all('img'):
...
def fetch_article_detail(url):
    ...
    if existing and existing.get('ai_content') and isinstance(existing.get('ai_content'), dict):
        ...
        has_wrong_og_img = bool(
            ...
            any(s in ai_cnt.get('og_img', '') for s in ['rcv.NEWSIS', 'golf', 'sports']) and
            any(k in orig_t for k in ['아파트', '집값', '부동산', '분양', '청약', '한남', '강남'])
        )
        ...
        # 결함(플랫폼 홍보 문구, 웹 찌꺼기 텍스트, 방송 출연진, 너무 짧은 볼륨, 불완전 요약, 잘못된 공유사진, 원문과 동일한 제목 등) 감지 시 재구성 실행
        if has_promo_junk or has_web_junk or has_caption_junk or has_host_junk or has_bracket_tag or has_awkward_title or has_wrong_og_img or has_duplicate_summary or is_abstract_template or has_double_dot or is_same_as_raw or is_meaningless or is_too_short or has_incomplete_summary:
